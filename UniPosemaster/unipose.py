...
class Trainer(object):
    def __init__(self, args):
        ...
        self.train_loader, self.val_loader = getDataloader(self.dataset, self.train_dir,self.batch_size,
...
parser.add_argument('--train_dir', default=hub.load("hub://activeloop/lsp-train"),type=str, dest='train_dir')
parser.add_argument('--val_dir', type=str, dest='val_dir', default=hub.load("hub://activeloop/lsp-test"))
...
if args.dataset == 'LSP':
    args.train_dir  = hub.load("hub://activeloop/lsp-train")
    args.val_dir    = hub.load("hub://activeloop/lsp-test")
    args.pretrained = 'D:\\CEG\\FYP\\UniPose-master\\UniPose Weights\\UniPose_LSP.tar'
